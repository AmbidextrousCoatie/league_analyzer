...
if __name__ == "__main__":
    ...
    league_ll = DataGeneratorLeague(league_name="LL1 Nord", league_level=4, number_of_teams=6, number_of_players_per_team=4)
    league_bzl = DataGeneratorLeague(league_name="BZL 2 Nord", league_level=5, number_of_teams=6, number_of_players_per_team=4)
    ...
    all_seasons = ["18/19", "19/20", "20/21", "21/22", "22/23"]
    all_leagues = [league_bayl, league_ll, league_bzl]
    ...
    if 1:
        for season in all_seasons:
            ...
            transfer_teams_after_season(league_ll, league_bzl, 1)
